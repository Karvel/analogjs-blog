...
@Component({
  ...
  template: `
    <div
      class="container absolute right-4 bottom-12 bg-white dark:bg-[#242424] rounded-md p-4 text-slate-900 dark:text-neutral-100 border-2 dark:border-white border-slate-900"
    >
